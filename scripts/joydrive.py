...
def test_clients():
    # test params
    host = "192.168.1.124" # "trainmydonkey.com" for virtual racing server
    port = 9091
    num_clients = 1
    clients = []
    ...
    # Car config
    msg = '{ "msg_type" : "car_config", "body_style" : "car01", "body_r" : "128", "body_g" : "0", "body_b" : "128", "car_name" : "Mecho", "font_size" : "40" }'
    clients[0].send(msg)
    time.sleep(1)
