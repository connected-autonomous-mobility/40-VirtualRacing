...
class RaceClient(SDClient):
    ...
    def on_msg_recv(self, json_packet):
        ...
        if json_packet['msg_type'] == "telemetry":
            ...
            myencoder1 = json_packet["wheelEncoder1"]
            myencoder2 = json_packet["wheelEncoder2"]
            myencoder3 = json_packet["wheelEncoder3"]
            myencoder4 = json_packet["wheelEncoder4"]
            print(myencoder1,myencoder2,myencoder3,myencoder4)
