...
#model_file = "parkinglotnerds11.h5" 
#model_file = "parkinglotnerds10.h5" 
...
for i in range(num_clients):
    ...
    with open(conf_file, "wt") as outfile:
        ...
        ###
        #outfile.write('AI_THROTTLE_MULT = 1.15\n') 
        outfile.write('AI_THROTTLE_MULT = 1.0\n') 
        ...
        ###temp out
        outfile.write('RECORD_DURING_AI = True\n') 
        outfile.write('SIM_RECORD_LOCATION = True\n')
