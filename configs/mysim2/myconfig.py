...
JOYSTICK_MAX_THROTTLE = 1.0#0.85 ####FAST### 0.7 #0.5         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
...
GYM_CONF = { "body_style" : "bare", "body_rgb" : (256, 256, 20), "car_name" : "Parking Lot Nerds", "font_size" : 50} 
