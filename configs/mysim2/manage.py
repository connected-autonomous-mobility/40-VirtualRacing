...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[]):
    ...
    if cfg.DONKEY_GYM:
        ...
        ###rbx enable on raceday if simulator is not running on same machine as the client ***
...
#rbx
#    ctr2 = LocalWebController(port=cfg.WEB_CONTROL_PORT, mode=cfg.WEB_INIT_MODE)
#    V.add(ctr2, 
#          inputs=['cam/image_array'],
#          outputs=['user/angle', 'user/throttle', 'user/mode', 'recording'],
#          threaded=True)
