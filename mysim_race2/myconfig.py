...
JOYSTICK_MAX_THROTTLE = 0.95 #0.45         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
JOYSTICK_STEERING_SCALE = 0.4       #some people want a steering that is less sensitve. This scalar is multiplied with the steering -1 to 1. It can be negative to reverse dir.
...
# #ROBOHAT MM1
#HAVE_ROBOHAT = True 
HAVE_ROBOHAT = False #True            # set to true when using the Robo HAT MM1 from Robotics Masters.  This will change to RC Control.
MM1_STEERING_MID = 1500         # Adjust this value if your car cannot run in a straight line
#MM1_MAX_FORWARD = 2000          # Max throttle to go fowrward. The bigger the faster
#MM1_MAX_FORWARD = 600 # 0.3          # Max throttle to go fowrward. The bigger the faster
MM1_MAX_FORWARD = 500 # 0.25    
...
MM1_SERIAL_PORT = '/dev/ttyACM0'  # Serial Port for reading and sending MM1 data.
# 
# #RECORD OPTIONS
...
DONKEY_GYM = True
#DONKEY_SIM_PATH = "/media/rainer/_data/30-projects/DonkeySimulator/DonkeySimLinuxMayRaceEdition_v20.5.16/DonkeySimLinux/donkey_sim.x86_64" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
...
GYM_CONF = { "body_style" : "car01", "body_rgb" : (18, 128, 22), "car_name" : "pln_r2_4", "font_size" : 100} # body style(donkey|bare|car01) body rgb 0-255
